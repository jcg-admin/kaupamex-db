...
Verifica antes de migrar:
  ...
  3. Schema kaupamex_core accesible con el usuario app

Después de migrar verifica:
  4. Tablas Django creadas en kaupamex_core
...
def main():
    ...
    schema_map = {
        'prod': env.get('DB_NAME', 'kaupamex_core'),
        'qa':   env.get('DB_QA_NAME', 'kaupamex_core_qa'),
    }
